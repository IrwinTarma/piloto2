...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2017 a las 00:03:52
...
(1, 1, 2, 'LOTE3', 110.00, '2017-08-27 23:48:21', '2017-08-27 23:48:21', 5, 1, 5.00, 1),
(2, 2, 2, 'LOTE3', 110.00, '2017-09-28 23:48:21', '2017-08-27 23:48:21', 5, 1, 5.00, 1);
...
CREATE TABLE `detalle_nota_ingreso` (
  ...
  `peso_cant` float(8,2) DEFAULT NULL,
...
(76, 49, 1, 'código de prueba', 100.25, 1, 1, '2017-09-07 05:00:00');
...
(5, 'Irwin Yauri Orihuela', 'wirwinw@gmail.com', '$2y$10$5vko2Fn9B3TKzPlWlEOvc.MJuUNNKqCCDUowl6rYl3KtdlFob1rqa', 1, '2dfa38b4d3edacfc8454b1f471fbe287', 1, 'aZkbVPgN4u9fza0HVzZFWv04sBg29uxHPz0VW3UuU8ftOtdtOWD6B97HpRQZ', '2017-09-01 22:49:50', '2017-09-02 04:58:29', NULL);
...
--
ALTER TABLE `detalle_nota_ingreso`
  MODIFY `dNotIng_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
--
-- AUTO_INCREMENT de la tabla `detalle_nota_ingreso_a`
--
ALTER TABLE `detalle_nota_ingreso_a`
  MODIFY `dNotInga_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nota_ingreso`
  MODIFY `ning_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
-- AUTO_INCREMENT de la tabla `nota_ingreso_a`
--
ALTER TABLE `nota_ingreso_a`
  MODIFY `ninga_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nota_ingreso_a`
  ADD CONSTRAINT `FK_color_id` FOREIGN KEY (`color_id`) REFERENCES `color` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
