        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Despacho de terceros</div>
                    <div class="panel-body">

                        <a href="{{ url('/despacho-terceros/despacho-terceros/create') }}" class="btn btn-primary btn-xs" title="Nueva Compra"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a>
                        <br/>
                        <br/>
                                ...
                                @foreach($despachos as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/despacho-terceros/despacho-terceros', $item->id],
                                        ...
                                        <td colspan="9">
                                            ...
                                            <?php foreach ($item->detalles as $detalle) : ?>
                                                <tr>
                                                    ...
                                                    <td>{{$detalle->producto->nombre_generico}}</td>
                                                    <td>{{ is_null($detalle->color) ? '' : $detalle->color->nombre }}</td>
