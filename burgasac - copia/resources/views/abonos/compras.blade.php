                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($compras as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nro_abonos }}</td>
                                        <td>
                                            <?php if($item->nro_abonos == 0) : ?>
                                                <a href="{{ url('abono/abonos/create') . '/' . $item->id }}" class="btn btn-primary">Agregar Abonos</a>
                                            <?php else : ?>
                                                <a href="{{ url('/abono/abonos/' . $item->id . '/edit') }}" class="btn btn-primary" title="Editar Abono">Editar Abonos</a>
                                            <?php endif ?>
                                        </td>
                                    </tr>
