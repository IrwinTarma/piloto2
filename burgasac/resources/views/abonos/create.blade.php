        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Crear Nuevo Abono</div>
                    <div class="panel-body">

                        {!! Form::open(['url' => '/abono/abonos', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-4">
                                ...
                                {!! Form::submit(isset($submitButtonText) ? $submitButtonText : 'Guardar Abono', ['class' => 'btn btn-primary']) !!}
